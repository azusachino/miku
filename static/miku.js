...
(function () {
  ...
  function syncBrandAssets() {
    ...
    // Theme-specific query keys prevent browsers from retaining the previous
    // SVG favicon when switching between the dark and light marks.
    ...
    if (favicon) favicon.setAttribute("href", asset);
  }
